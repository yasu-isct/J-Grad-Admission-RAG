...
def rule01a_client(tmp_path_factory: pytest.TempPathFactory, real_document_kb):
...
def test_rule01a_real_fact_boundaries_are_exact(rule01a_client, real_document_kb) -> None:
    _, _ = rule01a_client
