...
def rule02a_client(tmp_path_factory: pytest.TempPathFactory, real_document_kb):
...
def test_rule02a_restores_exact_page8_gpt_fact(rule02a_client, real_document_kb) -> None:
