...
def test_real_fact_00063_rule_findings_preserve_status_page_and_non_eligibility(
    ...
    assert finding.citations[0].fact_id == "fact:00069"
...
- [fact:00069, p.7] 文書 `isct_2027_4_2026_9_master` / 規則 `isct-master-individual-review-age-22-criterion` / 役割: 主要 / 参照元: 規則所見
